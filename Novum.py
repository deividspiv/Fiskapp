...
def _label(text, size=11, color=COLOR_RESPIRO_DARK, spacing=1.5):
    """Pequeña etiqueta en mayúsculas con espaciado de letra."""
    return ft.Text(
        text.upper(),
        size=size,
        color=color,
        weight=ft.FontWeight.W_600,
        # letter_spacing no es un parámetro nativo en Flet Text,
        # se simula con la fuente y el peso
    )
    ...
    def route_change(e):
                                ...
                                ft.Container(
                                    content=ft.Column([
                                        ft.Container(
                                            ...
                                            bgcolor="#33FFFFFF",
                                            alignment=ft.alignment.center,
                                            border=ft.border.all(1.5, "#55FFFFFF"),
                                        ),
        ...
        # ── 1.5 FORMULARIO ────────────────────────────────────────────────────
            ...
            nombre_field = ft.TextField(
                ...
                focused_border_color=COLOR_RESPIRO,
                cursor_color=COLOR_RESPIRO,
                bgcolor=COLOR_BG_CLARO,
                label_style=ft.TextStyle(color=COLOR_RESPIRO_DARK),
            )
            ...
            btn_continuar = ft.Container(
                ...
                border_radius=27,
                alignment=ft.alignment.center,
                shadow=ft.BoxShadow(blur_radius=18, color="#28a3968d", offset=ft.Offset(0, 6)),
            )
                ...
                controls=[
                    ft.Container(
                        ...
                        content=ft.Column(
                            [
                                ft.Row([
                                    _back_btn(lambda _: page.go("/login")),
                                    ft.Container(expand=True),
                                ]),
                                ...
                                ft.Text("Bienvenida", size=32, weight=ft.FontWeight.BOLD, color=COLOR_TEXTO_OSCURO, font_family="DM Sans"),
                                ft.Text(
                                    "Ingresa tus datos para acceder\na tu espacio de bienestar",
                                    size=14,
        ...
        # ── 3. PAGO ───────────────────────────────────────────────────────────
            ...
            def _pago_btn(icono, label, bg, fg, on_click_fn=None, url=None):
                return ft.Container(
                    ...
                    border_radius=16,
                    border=ft.border.all(1, f"{fg}22"),
            ...
            def pagar_recepcion_click(e):
                snack = ft.SnackBar(
                    ft.Text("Solicitud enviada. Paga en recepción.", color=COLOR_TEXTO_BLANCO),
                    bgcolor=COLOR_RESPIRO,
                )
            ...
            page.views.append(ft.View(
                ...
                controls=[
                    ft.Container(
                        ...
                        content=ft.Column([
                            ft.Row([
                                _back_btn(lambda _: page.go("/paquetes")),
                                ft.Container(expand=True),
                            ]),
                            ft.Container(height=28),

                            _label("Resumen de compra"),
        ...
        # ── 4. SERVICIOS Y AGENDA ─────────────────────────────────────────────
            ...
            def recargar_pantalla():
                ...
                horarios_ui.controls.append(
                    ft.Container(
                        content=ft.ProgressRing(color=COLOR_RESPIRO, width=32, height=32, stroke_width=3),
                        alignment=ft.alignment.center,
                        padding=40,
                    )
                )
                ...
                for serv in ["Pilates", "Yoga", "Ejercicios Funcionales"]:
                    ...
                    servicios_ui.controls.append(ft.Container(
                        content=ft.Text(
                            serv,
                            weight=ft.FontWeight.W_600,
                            color=COLOR_TEXTO_BLANCO if es_activo else COLOR_RESPIRO_DARK,
                            size=13,
                        ),
                        ...
                        shadow=ft.BoxShadow(
                            blur_radius=10 if es_activo else 0,
                            color="#20a3968d",
                ...
                for i in range(14):
                    ...
                    tiene_reserva = any(
                        (dia_str in f) or (f in dia_str)
                        for f in fechas_reservadas_limpias
                    )

                    indicador = ft.Container(
                        width=6, height=6,
                        bgcolor=COLOR_TEXTO_BLANCO if es_seleccionado else COLOR_RESPIRO,
                        border_radius=3,
                    ) if tiene_reserva else ft.Container(height=6)
                    ...
                    dias_ui.controls.append(ft.Container(
                        ...
                        shadow=ft.BoxShadow(
                            blur_radius=14 if es_seleccionado else 0,
                            color="#22a3968d",
                            offset=ft.Offset(0, 4),
                        ),
                ...
                if AppDB.es_dia_bloqueado(fecha_str):
                    ...
                    dia_ya_reservado = any(
                        (fecha_str in f) or (f in fecha_str)
                        for f in fechas_reservadas_limpias
                    )
                        ...
                        horarios_ui.controls.append(
                            ft.Container(
                                content=ft.Column([
                                    ...
                                    ft.Text(
                                        f"Sin clases de {vista_estado['servicio_activo']}",
                                        color=COLOR_RESPIRO_DARK,
                                        size=14,
                                    ),
                                ], alignment=ft.MainAxisAlignment.CENTER, horizontal_alignment=ft.CrossAxisAlignment.CENTER),
                    ...
                    for h in clases_del_dia:
                        ...
                        if ya_agendado:
                            ...
                            badge_bg = COLOR_ACCENT_LIGHT
                            badge_fg = COLOR_RESPIRO_DARK
                            badge_txt = "Día Reservado"
                            accion_btn = None
                        else:
                        ...
                        horarios_ui.controls.append(_card(
                            ft.Row([
                                ft.Column([
                                    ...
                                    ft.Row([
                                        ft.Icon(ft.icons.PERSON_OUTLINE, size=13, color=COLOR_RESPIRO_DARK),
                                        ft.Text(h['instructor'], size=12, color=COLOR_RESPIRO_DARK),
                                    ], spacing=4),
                                    ft.Row([
                                        ft.Icon(ft.icons.PEOPLE_OUTLINE, size=13, color=cupo_color),
                                        ft.Text(f"{h['cupo']} lugares", size=12, color=cupo_color),
                                    ], spacing=4),
                                ], spacing=2),
                                ft.Container(expand=True),
                                ft.Container(
            ...
            def al_seleccionar_dia(f):
                vista_estado["fecha_activa"] = f
                recargar_pantalla()

            def al_seleccionar_servicio(s):
                vista_estado["servicio_activo"] = s
                recargar_pantalla()
            ...
            def confirmar_reserva(clase):
                ...
                if AppDB.reservar_clase(telefono_alumno, clase["id"]):
                    snack = ft.SnackBar(
                        ft.Text("¡Reserva confirmada! Se descontó 1 clase.", color=COLOR_TEXTO_BLANCO),
                    ...
                    ft.Container(
                        content=ft.Column([
                            ...
                            ft.Container(
                                content=ft.Row([
                                    ft.Column([
                                        ft.Text(f"Hola, {primer_nombre} 👋",
                                                size=24, weight=ft.FontWeight.BOLD, color=COLOR_TEXTO_OSCURO),
                                        ft.Text("Reserva tu próxima clase", size=13, color=COLOR_RESPIRO_DARK),
                                    ], spacing=2),
                                    ft.Container(expand=True),
                                    _avatar(inicial, on_click=lambda _: page.go("/perfil")),
                                ]),
                            ...
                            # Sección horarios
                            ft.Container(
                                content=_section_title("Horarios Disponibles"),
                                padding=ft.padding.symmetric(horizontal=24),
                            ),
                            ft.Container(height=12),
        ...
        # ── 4.5 PERFIL ────────────────────────────────────────────────────────
            ...
            def ejecutar_cancelacion_final(e):
                ...
                snack = ft.SnackBar(
                    ft.Text(msg, color=COLOR_TEXTO_BLANCO),
            ...
            def preparar_cancelacion(res):
                ...
                if es_penalizable:
                    dlg_cancelar.content = ft.Text(
                        "Faltan menos de 12 horas para tu clase. Si cancelas perderás este crédito según nuestra política.\n\n¿Deseas cancelar de todos modos?",
                        color=ft.colors.RED_600, size=13,
                    )
                else:
                    dlg_cancelar.content = ft.Text(
                        "¿Segura que deseas cancelar tu clase?\nTu crédito será devuelto automáticamente.",
                        size=13,
                    )
            ...
            for res in mis_reservas:
                ...
                estado_badge = ft.Container(
                    content=ft.Text(
                        res.get("estado", "").capitalize(),
                        size=11,
                        color=COLOR_RESPIRO if is_futura else COLOR_RESPIRO_DARK,
                        weight=ft.FontWeight.BOLD,
                    ),
                    bgcolor=COLOR_ACCENT_LIGHT if is_futura else "#F5F5F5",
                    padding=ft.padding.symmetric(horizontal=10, vertical=4),
                    border_radius=20,
                )
                elementos = [
                    ft.Row([
                        ft.Text(res.get("servicio", "Clase"), size=15, weight=ft.FontWeight.BOLD, color=COLOR_TEXTO_OSCURO),
                        ft.Container(expand=True),
                        estado_badge,
                    ]),
                    ft.Row([
                        ft.Icon(ft.icons.CALENDAR_TODAY_OUTLINED, size=13, color=COLOR_RESPIRO_DARK),
                        ft.Text(res.get("fecha", ""), size=13, color=COLOR_RESPIRO_DARK),
                    ], spacing=6),
                ]
                if is_futura:
                    elementos.append(ft.Row([
                        ...
                        ft.Container(
                            content=ft.Row([
                                ...
                                ft.Text("Cancelar", size=13, color=ft.colors.RED_400, weight=ft.FontWeight.W_600),
                            ], spacing=4),
                            on_click=lambda e, r=res: preparar_cancelacion(r),
                        ),
                    ]))

                lista_reservas_ui.controls.append(_card(
                    ft.Column(elementos, spacing=8),
                    padding=ft.padding.all(18),
                ))
            ...
            if not mis_reservas:
                lista_reservas_ui.controls.append(
                    ft.Container(
                        content=ft.Column([
                            ft.Icon(ft.icons.EVENT_NOTE_OUTLINED, size=36, color=COLOR_RESPIRO),
                            ft.Container(height=8),
                ...
                controls=[
                    ft.Container(
                        content=ft.Column([
                            ...
                            ft.Container(
                                content=ft.Row([
                                    _back_btn(lambda _: page.go("/servicios")),
                                    ft.Container(expand=True),
                                    ft.Text("Mi Perfil", size=18, weight=ft.FontWeight.BOLD, color=COLOR_TEXTO_OSCURO),
                                    ft.Container(expand=True),
                                ...
                                content=ft.Column([
                                    ...
                                    ft.Container(
                                        content=ft.Row([
                                            ...
                                            ft.Text(
                                                "¿Pagaste y no ves tus clases? Sincronizar",
                                                color=COLOR_RESPIRO,
                                                size=13,
                                                weight=ft.FontWeight.W_600,
                                            ),
                                        ...
                                        border=ft.border.all(1.5, COLOR_RESPIRO),
                                        border_radius=12,
        ...
        # ── 5. ADMIN ──────────────────────────────────────────────────────────
            ...
            txt_fecha_top = ft.Text(
                fecha_activa[0].strftime("%Y-%m-%d"),
                size=14,
                weight=ft.FontWeight.BOLD,
                color=COLOR_RESPIRO,
            )
            ...
            def set_modo_30(e):
                modo_agenda[0] = "30"
                btn_modo_30.bgcolor = COLOR_RESPIRO
                btn_modo_30.content.color = "white"
                btn_modo_dia.bgcolor = COLOR_ACCENT_LIGHT
                btn_modo_dia.content.color = COLOR_RESPIRO
                recargar_listas()

            def set_modo_dia(e):
                modo_agenda[0] = "dia"
                btn_modo_dia.bgcolor = COLOR_RESPIRO
                btn_modo_dia.content.color = "white"
                btn_modo_30.bgcolor = COLOR_ACCENT_LIGHT
                btn_modo_30.content.color = COLOR_RESPIRO
                recargar_listas()

            def _tab_btn(label, active, on_click_fn):
                return ft.Container(
                    content=ft.Text(label, size=13, weight=ft.FontWeight.W_600,
                                    color="white" if active else COLOR_RESPIRO),
                    bgcolor=COLOR_RESPIRO if active else COLOR_ACCENT_LIGHT,
                    padding=ft.padding.symmetric(horizontal=16, vertical=10),
                    border_radius=20,
                    on_click=on_click_fn,
                )
            ...
            drop_serv = ft.Dropdown(
                label="Servicio", options=opciones_servicios,
                border_color=COLOR_DIVIDER, focused_border_color=COLOR_RESPIRO,
                border_radius=12, bgcolor=COLOR_BG_CLARO,
            )
            drop_hora = ft.Dropdown(
                label="Horario",
                options=[ft.dropdown.Option("08:00 AM"), ft.dropdown.Option("09:15 AM"), ft.dropdown.Option("06:30 PM")],
                border_color=COLOR_DIVIDER, focused_border_color=COLOR_RESPIRO,
                border_radius=12, bgcolor=COLOR_BG_CLARO,
            )
            txt_inst = ft.TextField(
                label="Instructor", value="Staff",
                border_color=COLOR_DIVIDER, focused_border_color=COLOR_RESPIRO,
                border_radius=12, bgcolor=COLOR_BG_CLARO, expand=True,
            )
            txt_cupo = ft.TextField(
                label="Cupo", value="10",
                keyboard_type=ft.KeyboardType.NUMBER,
                border_color=COLOR_DIVIDER, focused_border_color=COLOR_RESPIRO,
                border_radius=12, bgcolor=COLOR_BG_CLARO, width=90,
            )
            ...
            def ver_detalles_clase(cid):
                ...
                dlg_detalles.content.controls.append(
                    ft.Container(content=ft.ProgressRing(color=COLOR_RESPIRO), alignment=ft.alignment.center, padding=20)
                )
                ...
                if hasattr(AppDB, 'obtener_alumnos_clase'):
                    ...
                    alumnos = [{"full_name": "Agrega AppDB.obtener_alumnos_clase()", "active_package": "pagado"}]
                ...
                if not alumnos:
                    ...
                    dlg_detalles.content.controls.append(
                        ft.Text(f"Total inscritos: {len(alumnos)}", weight="bold", color=COLOR_TEXTO_OSCURO)
                    )
                    for al in alumnos:
                        ...
                        dlg_detalles.content.controls.append(ft.ListTile(
                            leading=ft.Icon(ft.icons.PERSON_ROUNDED, color=color_icono),
                            title=ft.Text(al.get('full_name', 'Desconocido'), weight="bold"),
            ...
            def recargar_listas():
                ...
                lista_agenda.controls.append(
                    ft.Container(content=ft.ProgressRing(color=COLOR_RESPIRO), alignment=ft.alignment.center, padding=40)
                )
                page.update()
                lista_agenda.controls.clear()
                ...
                if not clases:
                    lista_agenda.controls.append(ft.Text("No hay clases programadas.", color=COLOR_RESPIRO_DARK))
                    ...
                    if not c.get('is_blocked'):
                        ...
                        lista_agenda.controls.append(
                            ft.Container(
                                content=ft.Row([
                                    ft.Container(
                                        content=ft.Icon(ft.icons.FITNESS_CENTER_ROUNDED, size=18, color=COLOR_RESPIRO),
                                    ...
                                    ft.Column([
                                        ft.Text(f"{fecha_lbl}{c['start_time']} — {c['service_name']}",
                                                weight=ft.FontWeight.BOLD, size=13, color=COLOR_TEXTO_OSCURO),
                                    ...
                                    ft.Row([
                                        ft.Container(
                                            content=ft.Icon(ft.icons.PEOPLE_ALT_OUTLINED, size=16, color=COLOR_RESPIRO),
                                        ...
                                        ft.Container(
                                            content=ft.Icon(ft.icons.DELETE_OUTLINE_ROUNDED, size=16, color=ft.colors.RED_400),
                                            width=32, height=32, border_radius=16,
                                            bgcolor="#FFEBEE",
                                            alignment=ft.alignment.center,
                                ...
                                border_radius=14,
                                border=ft.border.all(1, COLOR_DIVIDER),
                                shadow=ft.BoxShadow(blur_radius=8, color="#0A000000", offset=ft.Offset(0, 3)),
                            )
                        )
                ...
                if not bloqueos:
                    lista_bloqueos.controls.append(ft.Text("No hay días cerrados programados.", color=COLOR_RESPIRO_DARK))
                for b in bloqueos:
                    lista_bloqueos.controls.append(
                        ft.Container(
                            content=ft.Row([
                                ft.Container(
                                    content=ft.Icon(ft.icons.BLOCK_ROUNDED, size=16, color=ft.colors.RED_400),
                                ...
                                ft.Container(
                                    ...
                                    bgcolor="#FFEBEE",
                                    alignment=ft.alignment.center,
                                    on_click=lambda e, bid=b['id']: (AppDB.desbloquear_dia(bid), recargar_listas()),
                                ),
                            ], spacing=10),
                            bgcolor=COLOR_CARD_BG,
                            padding=ft.padding.all(14),
                            border_radius=14,
                            border=ft.border.all(1, "#FFD7D7"),
                        )
                    )
                page.update()
            ...
            def accion_publicar_clase(e):
                ...
                if AppDB.es_dia_bloqueado(f_str):
                    ...
                    drop_serv.value = None
                    drop_hora.value = None
                    recargar_listas()
                else:
            ...
            txt_fecha_bloqueo = ft.TextField(
                ...
                hint_text="Selecciona en el calendario →",
                read_only=True, expand=True,
                border_color=COLOR_DIVIDER, focused_border_color=COLOR_RESPIRO,
                border_radius=12, bgcolor=COLOR_BG_CLARO,
            )
            dp_bloqueo = ft.DatePicker(
                on_change=lambda e: setattr(txt_fecha_bloqueo, 'value', dp_bloqueo.value.strftime("%Y-%m-%d")) or page.update() if dp_bloqueo.value else None,
            ...
            def accion_bloquear_dia(e):
                ...
                if f_str:
                    if not AppDB.es_dia_bloqueado(f_str):
                        ...
                        recargar_listas()
                        snack = ft.SnackBar(ft.Text(f"Día {f_str} bloqueado."), bgcolor=ft.colors.GREEN_600)
                        txt_fecha_bloqueo.value = ""
                    else:
                        snack = ft.SnackBar(ft.Text("Ese día ya está bloqueado."), bgcolor=ft.colors.ORANGE_500)
                else:
                    snack = ft.SnackBar(ft.Text("Selecciona una fecha primero."), bgcolor=ft.colors.RED_500)
                page.overlay.append(snack)
                snack.open = True
                page.update()
            ...
            tab_crear = ft.Tab(
                ...
                content=ft.Container(
                    ...
                    content=ft.Column([
                        _section_title("Agendar Nueva Clase"),
                        ft.Container(height=16),
                        drop_serv,
                        ft.Container(height=10),
                        drop_hora,
                        ft.Container(height=10),
                        ft.Row([txt_inst, txt_cupo], spacing=10),
                        ft.Container(height=20),
                        ft.Container(
                            content=ft.Row([
                                ft.Icon(ft.icons.ADD_ROUNDED, color=COLOR_TEXTO_BLANCO, size=18),
                                ft.Text("Publicar Clase", color=COLOR_TEXTO_BLANCO, weight=ft.FontWeight.BOLD, size=14),
                            ], alignment=ft.MainAxisAlignment.CENTER, spacing=8),
                            bgcolor=COLOR_RESPIRO,
                            height=50,
                            border_radius=14,
                            alignment=ft.alignment.center,
                            shadow=ft.BoxShadow(blur_radius=12, color="#28a3968d", offset=ft.Offset(0, 4)),
                            on_click=accion_publicar_clase,
                        ),
                    ], spacing=0),
                ),
            )
            ...
            tab_agenda = ft.Tab(
                ...
                content=ft.Container(
                    padding=ft.padding.all(20),
                    content=ft.Column([
                        ft.Row([btn_modo_30, btn_modo_dia], spacing=8),
            ...
            tab_bloqueos = ft.Tab(
                ...
                content=ft.Container(
                    padding=ft.padding.all(20),
                    content=ft.Column([
                        _section_title("Días Inhábiles"),
                        ft.Container(height=4),
                        ft.Text("Cierra el estudio en fechas específicas.", size=12, color=COLOR_RESPIRO_DARK),
                        ft.Container(height=14),
                        ft.Row([
                            txt_fecha_bloqueo,
                            ft.Container(
                                content=ft.Icon(ft.icons.CALENDAR_MONTH_OUTLINED, color=ft.colors.RED_400, size=22),
                                width=46, height=46,
                                border_radius=14,
                                bgcolor="#FFEBEE",
                                alignment=ft.alignment.center,
                                on_click=lambda _: dp_bloqueo.pick_date(),
                            ),
                        ], spacing=8),
                        ft.Container(height=10),
                        ft.Container(
                            content=ft.Row([
                                ft.Icon(ft.icons.BLOCK_ROUNDED, color=COLOR_TEXTO_BLANCO, size=16),
                                ft.Text("Bloquear Fecha", color=COLOR_TEXTO_BLANCO, weight=ft.FontWeight.BOLD),
                            ], alignment=ft.MainAxisAlignment.CENTER, spacing=8),
                            bgcolor=ft.colors.RED_400,
                            height=48,
                            border_radius=14,
                            alignment=ft.alignment.center,
                            on_click=accion_bloquear_dia,
                        ),
                        ft.Container(height=20),
                        _section_title("Próximos cierres"),
                        ft.Container(height=10),
                        lista_bloqueos,
                    ], spacing=0),
                ),
            ...
            page.views.append(ft.View(
                ...
                controls=[
                    ...
                    ft.Container(
                        bgcolor=COLOR_CARD_BG,
                        padding=ft.padding.only(left=8, right=16, top=48, bottom=12),
                        ...
                        content=ft.Row([
                            ...
                            ft.Container(width=8),
                            ft.Column([
                                ft.Text("Panel Admin", size=16, weight=ft.FontWeight.BOLD, color=COLOR_TEXTO_OSCURO),
                                ft.Text("Novum Pilates", size=11, color=COLOR_RESPIRO_DARK),
                            ], spacing=0),
                            ft.Container(expand=True),
                            ft.Row([
                                txt_fecha_top,
                                ft.Container(
                                    content=ft.Icon(ft.icons.CALENDAR_MONTH_OUTLINED, color=COLOR_RESPIRO, size=18),
                                    width=36, height=36, border_radius=18,
                                    bgcolor=COLOR_ACCENT_LIGHT,
                                    alignment=ft.alignment.center,
